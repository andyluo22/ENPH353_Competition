...
model_path = '/home/fizzer/ros_ws/src/controller_pkg/node/my_model.pt4'
cnn_trainer = CNNTrainer((3,224,224) , 2)
model = tf.keras.models.load_model(model_path, custom_objects={'bc_loss': cnn_trainer.build_model})
